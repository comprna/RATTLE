...
read_set_t read_fasta_file(std::string file, bool filter, int lower_len, int upper_len);
read_set_t read_fastq_file(std::string file, bool filter, int lower_len, int upper_len);
